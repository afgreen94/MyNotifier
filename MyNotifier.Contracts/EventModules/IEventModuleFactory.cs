...
namespace MyNotifier.Contracts.EventModules
{
    public interface IEventModuleFactory : IEventModuleProvider, IEventModuleDefinitionProvider
    {
        ...
        ValueTask<ICallResult<IEventModule>> GetEventModuleAsync(IEventModuleDefinition definition, Contracts.IEventModuleParameterValues parameterValues);
        ValueTask<ICallResult<IEventModule>> GetEventModuleAsync(Guid eventModuleDefinitionId, Contracts.IEventModuleParameterValues parameterValues); //ParameterValue[][]); //need parameters  
