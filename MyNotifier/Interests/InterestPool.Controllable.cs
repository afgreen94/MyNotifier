...
namespace MyNotifier
{
    public partial class InterestPool
    {
        ...
        public class Controllable : IControllable<RegisterAndSubscribeToNewInterests>,
                                    ...
                                    IControllable<UpdateInterestsById>
        {
            ...
            //{
            //    {
            //        RegisterAndSubscribeToNewInterestsDefinition.Id,
            //        new RegisterAndSubscribeToNewInterestsWrapperBuilder()
            //    }
            //};

            public Contracts.Base.IDefinition Definition => throw new NotImplementedException();

            public Controllable(InterestPool interestPool, Contracts.Interests.IFactory interestFactory) { this.interestPool = interestPool; this.interestFactory = interestFactory; }
            ...
            private ICommandResult<TCommand> BuildFailedCommandResult<TCommand>(IDictionary<string, string> errorMap, bool failedForAllInterests) where TCommand : ICommand
            {
                throw new NotImplementedException();
            }
