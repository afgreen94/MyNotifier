...
{
    public class UpdateInterestsByIdDefinition : IUpdateInterestsByIdDefinition
    {
    ...
    public class UpdateInterestsById : IUpdateInterestsById
    {
        private readonly IUpdateInterestsByIdDefinition definition = new UpdateInterestsByIdDefinition();
